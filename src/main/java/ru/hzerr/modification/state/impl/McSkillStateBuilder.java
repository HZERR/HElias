...
public class McSkillStateBuilder extends StateBuilder {

    public McSkillStateBuilder() { super(); }
    ...
    @Override
    public State build() {
        final State mcSkill = new McSkillState(values);
        mcSkill.setName("McSkill");
        return mcSkill;
    }
    ...
    public static McSkillStateBuilder defaultBuilder() {
        McSkillStateBuilder instance =  new McSkillStateBuilder();
