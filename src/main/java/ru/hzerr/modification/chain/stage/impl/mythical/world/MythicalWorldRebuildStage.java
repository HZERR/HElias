...
public class MythicalWorldRebuildStage extends RebuildStage implements VBoxModificationEditable {

    private VBox vBox;

    public MythicalWorldRebuildStage(VBox vBox) {
        super();
        this.vBox = vBox;
    }
    ...
    @Override
    public void onStart() {
        LogManager.getLogger().debug("Starting the rebuilding phase of the MythicalWorld project");
        Platform.runLater(() -> {
            append(vBox, "Starting the rebuilding phase of the MythicalWorld project...");
    ...
    public void onExit(Object result) {
        LogManager.getLogger().debug("Completing the rebuilding phase of the MythicalWorld project");
